...
export interface IVideoFilter {
    /** 投稿者のID */
    "userId"?:  TFilter<number>,
    /** 再生数 */
    "viewCounter"?: TFilter<number>,
    /** マイリスト数 */
    "mylistCounter"?: TFilter<number>,
    /** 再生時間(秒) */
    "lengthSeconds"?: TFilter<number>,
    /** 動画の登校時間 */
    "startTime"?: TFilter<string>,
    /** スレッドのID */
    "threadId"?: TFilter<number>,
    /** コメント数 */
    "commentCounter"?: TFilter<number>,
    /** 最終コメント時間 */
    "lastCommentTime"?: TFilter<string>,
    /** カテゴリタグ */
    "categoryTags"?: TFilter<string>,
    /** チャンネルのID */
    "channelId"?: TFilter<number>,
    /** タグ(空白区切り) */
    "tags"?: TFilter<string>,
    /** タグ完全一致(空白区切り) */
    "tagsExact"?: TFilter<string>,
    /** ロックされたタグ(空白区切り) */
    "lockTagsExact"?: TFilter<string>,
    /** ジャンル */
    "genre"?: TFilter<string>,
    /** ジャンル完全一致 */
    "genre.keyword"?: TFilter<string>
}